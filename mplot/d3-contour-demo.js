var get_data = async ()=>{
    var f = await fetch("https://likev.github.io/test/high-surface-data/surface-p0-20050220.000");
    ...
    const svg = d3.select("#weather")
      ...
      setInterval(_=>{
        ...
        g.append("path")
            ...
            .attr("fill", 'none');//.attr("fill", color(threshold));
